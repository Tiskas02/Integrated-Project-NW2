...
<template>
<div>
    <botton v-if="$slots.default" class="rounded px-4 py-3 bg-gradient-to-r from-blue-700 to-blue-400 text-white shadow-md hover:bg-gradient-to-r hover:from-blue-900 hover:to-blue-700 cursor-pointer">
