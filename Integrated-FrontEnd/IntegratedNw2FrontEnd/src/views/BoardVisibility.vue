    ...
    >
      <div class="w-[40%] m-[auto] max-h-[80%]">
        ...
        >
          ...
          <div v-if="board.visibilities === 'public' " class="break-all itbkk-message">
            In public,Any one can view the board,Task list and Task detail of task in the board,Do you want to change visibility to public ?
          </div>
          <div v-else>
            <div class="break-all itbkk-message">
              In private,Only board owner can acess/control the board,Do you want to change visibility to private ?
            </div>
          </div>
