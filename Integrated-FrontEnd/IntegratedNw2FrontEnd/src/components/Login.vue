...
<template>
  ...
  <div class="flex items-center space-x-2 justify-center">
    ...
    <div class="relative w-fit overflow-hidden tablet:overflow-auto laptop:overflow-hidden flex items-center">
    ...
    <div class="w-full p-4 flex justify-center items-center">
      <div class="tablet:border tablet:p-24 tablet:rounded-xl tablet:bg-white">
        <div class="text-center font-sans font-medium text-3xl text-slate-700 mobile:mt-12 tablet:mt-0">
          Welcome
        </div>
        <div
